...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    try {
        ...
        $ticket = new Ticket(null, $defaultState, $existingCustomer ?? new Customer(null, "default_name", "default_email"), $existingEmployee ?? new Employee(null, "default_name", "default_password"), $title, $description, new DateTime(), null);
